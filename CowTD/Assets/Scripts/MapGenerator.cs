...
public class MapGenerator : MonoBehaviour
{
    ...
    // [SerializeField] let's Unity change the field in the editor
    ...
    private void generateMap()
    {
        ...
        while (reachedX == false)
        {
            ...
            if (loopCount == 500)
            {
                Debug.Log("generateMap loop for X ran too long - break");
                break;
            }
        ...
        while (reachedY == false)
        {
            ...
            if (loopCount == 500)
            {
                Debug.Log("generateMap loop for Y ran too long - break");
                break;
            }
